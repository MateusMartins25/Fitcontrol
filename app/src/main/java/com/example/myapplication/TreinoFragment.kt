 ...
 * Use the [TreinoFragment.newInstance] factory method to
...
class TreinoFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView = view.findViewById(R.id.recyclerTreino)

        adapter = ExercicioAdapter(mutableListOf())
